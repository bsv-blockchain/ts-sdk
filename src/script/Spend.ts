...
import {
  ...
  requireMinimalPush,
  requirePushOnlyUnlockingScripts,
  requireLowSSignatures,
  requireCleanStack
} from './limits.js'
import { DEFAULT_MACROS, scanScriptForMacros } from './macros/index.js'
import type { ScriptMacroDefinition } from './macros/index.js'
...
export default class Spend {
  ...
  constructor (params: {
    ...
    this.reset()
    scanScriptForMacros(this.unlockingScript, this.macros, this.macroOwnerId)
    scanScriptForMacros(this.lockingScript, this.macros, this.macroOwnerId)
  }
