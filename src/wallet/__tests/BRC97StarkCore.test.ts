...
describe('BRC-97 STARK core', () => {
  ...
  it('binds multiple traces into one shared transcript context', () => {
    ...
    const options = {
      ...
      maskDegree: 0,
      cosetOffset: 3n,
      transcriptDomain: 'BRC97_TEST_MULTI_TRACE'
    }
  ...
  it('proves cross-trace constraints over committed masked traces', () => {
    ...
    const options = {
      ...
      maskDegree: 0,
      cosetOffset: 3n,
      transcriptDomain: 'BRC97_TEST_MULTI_TRACE_CROSS'
    }
  ...
  it('links hidden constant columns over a shared equality domain', () => {
    ...
    const options = {
      ...
      cosetOffset: 3n,
      maskSeed: [1, 2, 3, 4],
      transcriptDomain: 'BRC97_TEST_MULTI_TRACE_CONSTANT_LINK'
    }
    const links = [{
  ...
  it('rejects hidden constant links without a shared equality domain', () => {
    ...
    const options = {
      ...
      cosetOffset: 3n,
      maskSeed: [1, 2, 3, 4],
      transcriptDomain: 'BRC97_TEST_MULTI_TRACE_CONSTANT_LINK_DOMAIN'
    }
    const links = [{
      name: 'constant-equality',
      left: { segment: 'left', column: 0 },
